...
public enum Ending {
    ...
    private Ending(RythmicString maleBase, RythmicString femaleBase, RythmicString famMale, RythmicString famFemale, RythmicString patMale, RythmicString patFemale) {
